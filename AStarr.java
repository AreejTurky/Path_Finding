...
public class AStarr {
    ...
    public AStarr(int rows, int cols, Node initialNode, List<Node> SetOfGoals, int hvCost, int diagonalCost ) {
        this.hvCost = hvCost;
    ...
    public AStarr(int rows, int cols, Node initialNode, List<Node> SetOfGoals) {
    ...
    private void setNodes() {
        for (int i = 0; i < searchArea.length; i++) {
            for (int j = 0; j < searchArea[0].length; j++) {
                ...
                node.calculate_Manhattan_Heuristic(getInitialNode());   
    ...
    private void nearest_goal()
    {
       ...
       { 
         //  System.out.println(goals);
           ...
           NearestGoal.calculate_Manhattan_Heuristic(getInitialNode());
           for(int i=1 ; i< goals.size() ; i++)
           {  
               goals.get(i).calculate_Manhattan_Heuristic(getInitialNode());
...
//////////////////////////////////////////////////////////////////////UNTILL HERE IT' JUST INITIALZATION/////////////////////////////////
    ...
    private void checkNode(Node currentNode, int col, int row, int cost) {  //Current node with upper row and col and DFDignoal=14
        ...
        if (!getClosedSet().contains(adjacentNode)) {    //not previously added
